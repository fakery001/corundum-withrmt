...
connect_debug_port u_ila_0/probe0 [get_nets [list {cfg_ext_function_number[0]} {cfg_ext_function_number[1]} {cfg_ext_function_number[2]} {cfg_ext_function_number[3]} {cfg_ext_function_number[4]} {cfg_ext_function_number[5]} {cfg_ext_function_number[6]} {cfg_ext_function_number[7]}]]
...
connect_debug_port u_ila_2/probe0 [get_nets [list {core_inst/core_inst/core_pcie_inst/core_inst/app.app_block_inst/direct_rx_rst[0]}]]
create_debug_port u_ila_2 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_2/probe1]
set_property port_width 1 [get_debug_ports u_ila_2/probe1]
connect_debug_port u_ila_2/probe1 [get_nets [list {core_inst/core_inst/core_pcie_inst/core_inst/app.app_block_inst/direct_tx_rst[0]}]]
