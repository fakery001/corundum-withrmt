...
# UART
set_property -dict {LOC B33 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports usb_uart_txd]
set_property -dict {LOC A28 IOSTANDARD LVCMOS18} [get_ports usb_uart_rxd]
...
# QSFP28 Interfaces
set_property -dict {LOC L53} [get_ports qsfp0_rx1_p]
set_property -dict {LOC L54} [get_ports qsfp0_rx1_n]
set_property -dict {LOC L48} [get_ports qsfp0_tx1_p]
set_property -dict {LOC L49} [get_ports qsfp0_tx1_n]
set_property -dict {LOC K51} [get_ports qsfp0_rx2_p]
set_property -dict {LOC K52} [get_ports qsfp0_rx2_n]
set_property -dict {LOC L44} [get_ports qsfp0_tx2_p]
set_property -dict {LOC L45} [get_ports qsfp0_tx2_n]
set_property -dict {LOC J53} [get_ports qsfp0_rx3_p]
set_property -dict {LOC J54} [get_ports qsfp0_rx3_n]
set_property -dict {LOC K46} [get_ports qsfp0_tx3_p]
set_property -dict {LOC K47} [get_ports qsfp0_tx3_n]
set_property -dict {LOC H51} [get_ports qsfp0_rx4_p]
set_property -dict {LOC H52} [get_ports qsfp0_rx4_n]
set_property -dict {LOC J48} [get_ports qsfp0_tx4_p]
set_property -dict {LOC J49} [get_ports qsfp0_tx4_n]
...
set_property -dict {LOC G53} [get_ports qsfp1_rx1_p]
set_property -dict {LOC G54} [get_ports qsfp1_rx1_n]
set_property -dict {LOC G48} [get_ports qsfp1_tx1_p]
set_property -dict {LOC G49} [get_ports qsfp1_tx1_n]
set_property -dict {LOC F51} [get_ports qsfp1_rx2_p]
set_property -dict {LOC F52} [get_ports qsfp1_rx2_n]
set_property -dict {LOC E48} [get_ports qsfp1_tx2_p]
set_property -dict {LOC E49} [get_ports qsfp1_tx2_n]
set_property -dict {LOC E53} [get_ports qsfp1_rx3_p]
set_property -dict {LOC E54} [get_ports qsfp1_rx3_n]
set_property -dict {LOC C48} [get_ports qsfp1_tx3_p]
set_property -dict {LOC C49} [get_ports qsfp1_tx3_n]
set_property -dict {LOC D51} [get_ports qsfp1_rx4_p]
set_property -dict {LOC D52} [get_ports qsfp1_rx4_n]
set_property -dict {LOC A49} [get_ports qsfp1_tx4_p]
set_property -dict {LOC A50} [get_ports qsfp1_tx4_n]
...
set_property -dict {LOC M42} [get_ports qsfp1_mgt_refclk_1_p]
set_property -dict {LOC M43} [get_ports qsfp1_mgt_refclk_1_n]
...
set_output_delay 0.000 [get_ports {qsfp1_refclk_oe_b qsfp1_refclk_fs}]
...
set_property -dict {LOC AL10} [get_ports {pcie_tx_n[0]}]
...
set_property -dict {LOC AM8} [get_ports {pcie_tx_n[1]}]
set_property -dict {LOC AN6} [get_ports {pcie_rx_p[2]}]
set_property -dict {LOC AN5} [get_ports {pcie_rx_n[2]}]
set_property -dict {LOC AN11} [get_ports {pcie_tx_p[2]}]
set_property -dict {LOC AN10} [get_ports {pcie_tx_n[2]}]
set_property -dict {LOC AN2} [get_ports {pcie_rx_p[3]}]
set_property -dict {LOC AN1} [get_ports {pcie_rx_n[3]}]
set_property -dict {LOC AP9} [get_ports {pcie_tx_p[3]}]
set_property -dict {LOC AP8} [get_ports {pcie_tx_n[3]}]
set_property -dict {LOC AP4} [get_ports {pcie_rx_p[4]}]
set_property -dict {LOC AP3} [get_ports {pcie_rx_n[4]}]
set_property -dict {LOC AR11} [get_ports {pcie_tx_p[4]}]
set_property -dict {LOC AR10} [get_ports {pcie_tx_n[4]}]
...
set_property -dict {LOC AR6} [get_ports {pcie_tx_n[5]}]
set_property -dict {LOC AT4} [get_ports {pcie_rx_p[6]}]
set_property -dict {LOC AT3} [get_ports {pcie_rx_n[6]}]
set_property -dict {LOC AT9} [get_ports {pcie_tx_p[6]}]
set_property -dict {LOC AT8} [get_ports {pcie_tx_n[6]}]
set_property -dict {LOC AU2} [get_ports {pcie_rx_p[7]}]
set_property -dict {LOC AU1} [get_ports {pcie_rx_n[7]}]
set_property -dict {LOC AU11} [get_ports {pcie_tx_p[7]}]
set_property -dict {LOC AU10} [get_ports {pcie_tx_n[7]}]
set_property -dict {LOC AV4} [get_ports {pcie_rx_p[8]}]
set_property -dict {LOC AV3} [get_ports {pcie_rx_n[8]}]
set_property -dict {LOC AU7} [get_ports {pcie_tx_p[8]}]
set_property -dict {LOC AU6} [get_ports {pcie_tx_n[8]}]
set_property -dict {LOC AW6} [get_ports {pcie_rx_p[9]}]
set_property -dict {LOC AW5} [get_ports {pcie_rx_n[9]}]
set_property -dict {LOC AV9} [get_ports {pcie_tx_p[9]}]
set_property -dict {LOC AV8} [get_ports {pcie_tx_n[9]}]
set_property -dict {LOC AW2} [get_ports {pcie_rx_p[10]}]
set_property -dict {LOC AW1} [get_ports {pcie_rx_n[10]}]
set_property -dict {LOC AW11} [get_ports {pcie_tx_p[10]}]
set_property -dict {LOC AW10} [get_ports {pcie_tx_n[10]}]
set_property -dict {LOC AY4} [get_ports {pcie_rx_p[11]}]
set_property -dict {LOC AY3} [get_ports {pcie_rx_n[11]}]
set_property -dict {LOC AY9} [get_ports {pcie_tx_p[11]}]
set_property -dict {LOC AY8} [get_ports {pcie_tx_n[11]}]
set_property -dict {LOC BA6} [get_ports {pcie_rx_p[12]}]
set_property -dict {LOC BA5} [get_ports {pcie_rx_n[12]}]
set_property -dict {LOC BA11} [get_ports {pcie_tx_p[12]}]
set_property -dict {LOC BA10} [get_ports {pcie_tx_n[12]}]
set_property -dict {LOC BA2} [get_ports {pcie_rx_p[13]}]
set_property -dict {LOC BA1} [get_ports {pcie_rx_n[13]}]
set_property -dict {LOC BB9} [get_ports {pcie_tx_p[13]}]
set_property -dict {LOC BB8} [get_ports {pcie_tx_n[13]}]
set_property -dict {LOC BB4} [get_ports {pcie_rx_p[14]}]
set_property -dict {LOC BB3} [get_ports {pcie_rx_n[14]}]
set_property -dict {LOC BC11} [get_ports {pcie_tx_p[14]}]
set_property -dict {LOC BC10} [get_ports {pcie_tx_n[14]}]
...
set_property -dict {LOC BC6} [get_ports {pcie_tx_n[15]}]
...
set_property -dict {LOC AR15} [get_ports pcie_refclk_1_p]
set_property -dict {LOC AR14} [get_ports pcie_refclk_1_n]
...
set_property PACKAGE_PIN BH26 [get_ports pcie_reset_n]
